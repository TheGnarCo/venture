...
Imagine you're an employee at a company where you have to be certified
to work on certain dangerous equipment. You stay current by reapplying
regularly, say once a year. Among other requirements, employees
should have at most one current application, and managers should be
able to make new applications for employees at will. (Apologies for
overloading the word "application.") That implies a couple things:

- If a manager creates a new application for an employee who already has one,
...
events in the database for auditing purposes. The concerns above don't relate
